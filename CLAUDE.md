...
### Comandos Claude Code para o frontend

```
Leia o CLAUDE.md e crie a estrutura do projeto Next.js para o painel admin
...
chips de apelidos e especialidades, toggles ativo/inativo, conforme o CLAUDE.md.
```
...
e filtros por tipo e status, conforme especificado no CLAUDE.md.
```
...
Claude Code vai ler automaticamente este arquivo `CLAUDE.md` como contexto do projeto.

Exemplos de comandos iniciais recomendados:

```
Leia o CLAUDE.md e configure a estrutura de pastas do projeto para o Marco 1.
```

```
Com base no CLAUDE.md, crie o script de migration SQL completo para o Supabase.
```

```
Implemente o serviço de identidade do cliente (deduplicação por phone_normalized) conforme o CLAUDE.md.
```
